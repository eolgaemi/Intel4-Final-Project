...
public:
    ...
    void setupUi(QWidget *Tab3TurtleBotControlPannel)
    {
        ...
        plabelFruitStatus->setPixmap(QPixmap(QString::fromUtf8(":/STF_Images/STF_Images/STF_Danger.png")));
        ...
        plabelLeafStatus->setPixmap(QPixmap(QString::fromUtf8(":/STF_Images/STF_Images/STF_Good.png")));
