...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, Sensor_Output_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Sensor_Output_Pin LD2_Pin */
  GPIO_InitStruct.Pin = Sensor_Output_Pin|LD2_Pin;
